    ...
    public partial class frmScreenSaver : Form
    {
        ...
        private void LoadSettings()
        {
            ...
            else
            {
                ...
                float fontSize = (float)Convert.ToDouble(((0.02 * this.Width) + 16));
            ...
            if (canPaint)
            {
                ...
                if (counter <= 4)
                {
                    ...
                    Font ft = new Font(font.Name, Convert.ToInt32(
                            Math.Round((font.Size / 1.9f), 2)), font.Style);
                    ...
                    else if (counterTrans == 1)
                    {
                        ft = new Font(font.Name, Convert.ToInt32(
                            Math.Round((font.Size / 1.6f), 2)), font.Style);
                        size = e.Graphics.MeasureString(txt, ft);
                    }
                    ...
                    {
                        ft = new Font(font.Name, Convert.ToInt32(
                            Math.Round((font.Size / 1.1f), 2)), font.Style);
                        size = e.Graphics.MeasureString(txt, ft);
                    }
                    else if (counterTrans == 5)
                    {
                        ft = new Font(font.Name, font.Size, font.Style);
                        size = e.Graphics.MeasureString(txt, ft);
                    }
                    int pointX = 0;
